  ...
  experience: [
    {
      ...
      bullets: [
        "Built the first production-scale human validation layer over an ML attribute extraction (mistral:7b): a three-role FastAPI + React system on PostgreSQL spanning 14,053 SKUs, with 1,064 review decisions on launch day.",
        "Recovered ~240K records (~27%) lost to a join defect.",
        "Drove schema drift to 0 via a Pydantic validation gate and a 12-rule canonicalisation engine (161/161 tests)."
      ],
      readouts: [
        { value: "14,053", label: "SKUs spanned" },
        { value: "1,064", label: "review decisions, launch day" },
        { value: "~240K", label: "records recovered (~27%)" },
        { value: "161/161", label: "tests passing" }
      ]
    },
    {
      company: "NIELIT",
      ...
      readouts: [
        { value: "80%+", label: "speech-emotion accuracy" },
        { value: "50,000+", label: "audio samples" },
        { value: "<200ms", label: "inference latency" },
        { value: "70%", label: "less research-synthesis time" }
      ]
    }
  ],
  projects: [
    {
      ...
      problem: "A retrieval-only baseline could answer policy questions but could not act: on a 30-row stratified eval it reached 0% tool-call success and 50% citation coverage.",
      built: "An agentic RAG assistant combining policy retrieval with typed MCP tool calls, run through a decide\u2013act\u2013reflect LangGraph loop. Citation guardrails refuse rather than guess, a 3-provider LLM failover keeps it up, and a GitHub Actions eval gate blocks regressions. Ships with a React/TypeScript agent-trace UI. All demo data is synthetic.",
      metrics: [
        { value: "0%\u2192100%", label: "tool-call success" },
        { value: "50%\u2192100%", label: "citation coverage" },
        { value: "0.99", label: "RAGAS faithfulness" },
        { value: "30", label: "row stratified eval" }
      ],
      tech: ["LangGraph", "MCP", "RAGAS", "Agentic RAG", "LLM failover", "GitHub Actions", "React", "TypeScript"],
    ...
    },
    {
      ...
      metrics: [
        { value: "2.16%", label: "WAPE vs 4.49% seasonal-naive" },
        { value: "52%", label: "forecast error cut" },
        { value: "56/56", label: "data-quality tests in CI" },
        { value: "94.7%", label: "CUPED variance reduction" },
        { value: "\u22122.2%", label: "DiD lockdown effect, non-significant" }
      ],
      tech: ["LightGBM", "dbt", "DuckDB", "A/B Testing", "CUPED", "Difference-in-Differences", "Streamlit", "OPSD data"],
    ...
    },
    {
      ...
      metrics: [
        { value: "20+", label: "real-time web sources" },
        { value: "70%", label: "faster research synthesis" }
      ],
      tech: ["LangGraph", "RAG", "Semantic retrieval", "Tavily", "Groq", "HuggingFace", "FastAPI", "Docker"],
  ...
  skills: [
    {
      ...
      items: ["Agentic RAG", "Multi-Agent Systems", "LangGraph", "MCP", "RAGAS", "Qdrant", "LLM Orchestration", "Prompt Engineering", "Guardrails", "HuggingFace Embeddings"]
    },
    {
      group: "Data Science & Statistics",
      items: ["Time-Series Forecasting", "A/B Testing", "Power Analysis & MDE", "SRM", "CUPED", "Difference-in-Differences", "Causal Inference", "EDA", "Feature Engineering"]
    },
    {
      group: "Data Engineering",
      items: ["SQL", "PostgreSQL", "dbt", "DuckDB", "ETL & Data Pipelines", "Data-Quality Testing", "Schema Design", "Pydantic"]
    },
    {
      group: "AI/ML",
      items: ["Deep Learning", "CNNs", "Transfer Learning", "NLP", "LightGBM", "MLflow", "Hyperparameter Tuning"]
    },
    {
      group: "MLOps & Deployment",
      items: ["FastAPI", "Docker", "GitHub Actions CI/CD", "Automated Eval Gates", "Streamlit", "Render", "AWS EC2/RDS"]
    },
    {
      group: "Programming",
      items: ["Python", "SQL", "Java", "TypeScript", "React"]
    }
  ],
  certifications: [
    { name: "Foundations of Deep Learning", grade: "Elite", institute: "IISc", year: "2026", provider: "NPTEL" },
    { name: "Python for Data Science", grade: "Elite + Silver", institute: "IIT Madras", year: "2026", provider: "NPTEL" },
    { name: "Introduction to Machine Learning", grade: "Elite", institute: "IIT Madras", year: "2025", provider: "NPTEL" },
    { name: "Programming in Java", grade: "Elite + Silver", institute: "IIT Kharagpur", year: "2025", provider: "NPTEL" }
  ]
};
